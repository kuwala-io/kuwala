...
<img src="./docs/images/header_github_kuwala_new.png" width="60%" />
...
[Airbyte](https://github.com/airbytehq/airbyte), [dbt](https://github.com/dbt-labs/dbt-core) and [prefect](https://github.com/prefecthq/prefect) together in one intuitive interface built with [React Flow](https://github.com/wbkd/react-flow).
...
can easily create dbt models and make them reusable to the frontend. We have already a catalog of many transformations that you can use in the canvas. The complete documentation can be found here: [https://docs.kuwala.io/](https://docs.kuwala.io/transformation-catalog)
